...
# Add an input layer 
                        model.add(Dense(len(feature_tr.columns), activation='relu', input_shape=(len(feature_tr.columns),)))
...
# Add an output layer 
                        ...
                        model.fit(feature_tr_tr, label_tr,epochs=8, batch_size=500, verbose=1)
                        ...
                        a =  model.predict_proba(feature_vl)
