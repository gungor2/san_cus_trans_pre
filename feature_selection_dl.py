...
# Add an input layer 
                        model.add(Dense(len(temp_best), activation='relu', input_shape=(len(temp_best)-1,)))
...
# Add an output layer 
                        ...
                        model.fit(feature_tr, target_tr,epochs=20, batch_size=50, verbose=1)
                        

                        
                        pre =  model.predict(feature_vl)
